  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileHover={{ x: 5 }}
        transition={{ duration: 0.35 }}
        className="listBreakpoint:hidden flex flex-col items-stretch justify-between w-full max-w-[20rem] h-[8.375rem] p-6 mb-4 mx-auto rounded-lg bg-white dark:bg-blue-dark shadow-[0_10px_10px_-10px_rgba(72,84,159,0.10)] transition-colors duration-500"
        onClick={() => setOpenInvoice()}
      >
